  ...
  <div class="container">
    ...
    <form action="index.php" class="form" id="login" method="post">
      ...
      <div class="form__input-group">
        <input type="text" class="form__input" autofocus placeholder="Username or Email" id="loginUser" required>
        <div class="form__input-error-message"></div>
      </div>
      <div class="form__input-group">
        <input type="password" class="form__input" autofocus placeholder="Password" id="loginCredentials" required>
        <div class="form__input-error-message"></div>
      </div>
